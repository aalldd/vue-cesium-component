---
title: 'collision-碰撞分析'
---

# 覆土埋深分析

> municipal-collision 碰撞分析，用于查询一定地图范围内，管线的碰撞情况


## 基本用法

> 基本的碰撞分析用法，需配合result组件一起使用，用来展示碰撞分析结果

> 需传入layerData，用于展示碰撞规则树，query,用于获取查询的参数
